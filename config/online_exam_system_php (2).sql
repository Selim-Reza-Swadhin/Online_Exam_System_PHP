...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Sep 22, 2020 at 08:36 AM
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='admin table created';
...
CREATE TABLE IF NOT EXISTS `tbl_answer` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=49 DEFAULT CHARSET=utf8 COMMENT='answer table with foreign key';
...
CREATE TABLE IF NOT EXISTS `tbl_question` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COMMENT='question tanle created';
...
CREATE TABLE IF NOT EXISTS `tbl_users` (
  ...
  PRIMARY KEY (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='user table success';
